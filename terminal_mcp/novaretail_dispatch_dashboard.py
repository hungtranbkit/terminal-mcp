...
# The SAME global bar every other dashboard page carries. An ops screen is
# not a lesser page: before this it was a one-way street with browser Back as
# the only exit. See dashboard_nav.py.
from .dashboard_nav import with_global_nav as _with_global_nav
HTML=_with_global_nav(HTML, 'dispatch-monitor')
