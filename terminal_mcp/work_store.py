...
from .analysis_gate import AnalysisGateError, evaluate as evaluate_analysis_gate
...
class WorkStore:
    def __init__(self, path: str | os.PathLike[str] | None = None, *,
        ...
        # judged. See docs/AI_ANALYSIS_GATE.md.
    ...
    def transition_run(self, work_id: str, to_state: str, *, actor: str | None = None,
        ...
        if to_state == READY:
            ...
            if not verdict.allowed:
                ...
                raise AnalysisGateError(verdict)
        now = _now()
        with self._connection:
            self._connection.execute(
