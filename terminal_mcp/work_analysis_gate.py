"""Opt-in WorkRun analysis contract (metadata.analysis_gate).

This preserves the WorkStore READY-transition contract independently of the
queue task profiles evaluated by analysis_gate.check_analysis_gate. Existing
work runs without this metadata retain their previous transition behavior.
