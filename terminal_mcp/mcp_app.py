...
def build_mcp(service: TerminalService | None = None,
    ...
    # Ten tools, defined once in repo_tools.py because the public
    # read-only observer surface (observer_app.py) must expose the exact
    # same schemas; see that module's docstring for the read-only
    # guarantee and the error-code contract.
    register_repo_tools(server, repo, actor="mcp")
