...
from terminal_mcp import analysis_gate as ag
...
def test_na_is_not_allowed_for_other_fields():
    verdict = ag.evaluate(_full(invariants={"n/a": True, "reason": "none"}))
    assert verdict.allowed is True or "invariants" not in verdict.missing_fields
