...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 47  # +terminal_registry_list/_get/_search/_reopen/_purge (Persistent Session Registry)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 47  # +terminal_registry_list/_get/_search/_reopen/_purge (Persistent Session Registry)
