...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 117  # ...previous total (115) +2 terminal_task_create_incident/list_active_incidents (Incident lane, sec20.6 Phase B)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 117  # ...previous total (115) +2 terminal_task_create_incident/list_active_incidents (Incident lane, sec20.6 Phase B)
