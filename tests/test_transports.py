...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 115  # ...previous total (114) +1 terminal_task_check_dor (Delivery discipline DoR, sec20.6 Phase A)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 115  # ...previous total (114) +1 terminal_task_check_dor (Delivery discipline DoR, sec20.6 Phase A)
