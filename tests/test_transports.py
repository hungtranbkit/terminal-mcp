...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 114  # ...previous total (111) +3 terminal_task_create_isolated/worktree_status/worktree_cleanup (Git isolation, sec20.4)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 114  # ...previous total (111) +3 terminal_task_create_isolated/worktree_status/worktree_cleanup (Git isolation, sec20.4)
