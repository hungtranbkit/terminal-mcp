...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 128  # ...previous total (126) +2 terminal_emergency_stop/terminal_emergency_resume (§20.6 Phase E)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 128  # ...previous total (126) +2 terminal_emergency_stop/terminal_emergency_resume (§20.6 Phase E)
