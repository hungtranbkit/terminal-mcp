...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 111  # ...previous total (107) +4 terminal_task_split/approve_plan/children/complete_parent (Planner, sec20.3)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 111  # ...previous total (107) +4 terminal_task_split/approve_plan/children/complete_parent (Planner, sec20.3)
