...
async def test_stdio_real_handshake_and_tools(tmp_path):
    ...
    assert len(names) == 93  # ...previous total (91) +terminal_queue_loop_status/terminal_queue_loop_run_once (2, auto-dispatch background loop)
...
async def test_http_real_handshake_tools_and_security(http_server, tmux_session_factory):
    ...
    assert len(tools.tools) == 93  # ...previous total (91) +terminal_queue_loop_status/terminal_queue_loop_run_once (2, auto-dispatch background loop)
