...
def test_a_recoverable_row_still_recovers_after_a_restart(tmp_path):
    ...
    # Current polling retains an unavailable node's watch. Seed a legacy
    # disabled row explicitly to exercise upgrade/restart recovery.
    first.store.set_enabled(key, False, disabled_reason="node_unreachable")
